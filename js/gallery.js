const ACTIVE_SLIDE_CLASSNAME = 'gallery__slides__img__active';

const slidesNodes = Array.from(document.querySelectorAll('.gallery__slides__item'));
console.log(slidesNodes);
const prevButtonNode = document.querySelector('.prev');
const nextButtonNode = document.querySelector('.next');
let activeId;
